    ...
    <div className="d-inline-flex p-2">
      ...
      <Modal show={showPostModal} onHide={handleClosePostModal} >
        <Modal.Header closeButton style={{ color: '#FFF' }}>
          <Modal.Title style={{ color: '#FFF' }}>Post</Modal.Title>
        </Modal.Header>
        <Modal.Body style={{ wordWrap: 'break-word', overflowWrap: 'break-word', color: '#FFF' }}>
          <p>{posts.content}</p>
          <p>{formattedDate}</p>
          <CommentModal postId={posts._id} />
        </Modal.Body>
        <Modal.Footer style={{ color: '#FFF' }}>
      ...
      <Modal show={showEditModal} onHide={handleCloseEditModal} >
        <Modal.Header closeButton style={{ color: '#FFF' }}>
          <Modal.Title style={{ color: '#FFF' }}>Would you like to update or delete your post?</Modal.Title>
        </Modal.Header>
